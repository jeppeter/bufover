...
{
    return EnablePrivilege(pToken,SE_DEBUG_NAME);
}

int DisableDebugPriv(HANDLE* pToken)
{
    return DisablePriviledge(pToken,SE_DEBUG_NAME);
}

int EnableLoadDriver(HANDLE* pToken)
{
    return EnablePrivilege(pToken,SE_LOAD_DRIVER_NAME);
}

int DisableLoadDriver(HANDLE* pToken)
{
    return DisablePriviledge(pToken,SE_LOAD_DRIVER_NAME);
}
